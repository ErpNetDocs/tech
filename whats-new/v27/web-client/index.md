...
A new "Update records" function is now available in supported navigators, allowing you to update existing records or create new ones directly from the navigator with a single command.
