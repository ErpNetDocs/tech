...
We have introduced several improvements in **user creation and maintenance** to streamline data entry and ensure consistent defaults.
...
👍 Default Language initialization (R39700-3
...
- This rule applies **only on insert**.
- If `DefaultLanguage` is later cleared, it is **not re-populated automatically**.
  - In this case, the system uses **English as an implicit fallback**.
