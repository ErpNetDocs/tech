...
If the [J35666 Delete old history data for attribute changes](~/advanced/jobs/J35666.md) job is configured and the retention period is exceeded, old attribute changes records will be deleted. 
- c.The user sets it manually.
