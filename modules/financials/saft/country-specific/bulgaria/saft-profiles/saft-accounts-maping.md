...
Сметките, които се свързват със сметки 401 и 411 трябва да имат задължително аналитичност Контрагент, която взима стойности от системната дефиниция Субекти.
