...
| Pieces| IF EXISTS(MeasurementUnit((IsDefaultUnit == True) && (MeasurementCategory == ExciseAdministrativeDocumentLine.Product.BaseMeasurementCategory) && (MeasurementUnitCode == "PCE")) <br/>THEN    ExciseDeclarations.WarehouseGoods.Pieces = ExciseAdministrativeDocumentLine.Product.ExciseProductTypes.Capacity and is exported <br/>ELSE   NOT exported|
