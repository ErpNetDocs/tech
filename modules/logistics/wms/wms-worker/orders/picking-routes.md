...
- The Zones specified as picking zones through the "Zone Type" policy - it is necessary to set "Policy Kind = Zone Type" and "Value = picking" if you want to use the **"Suggest Routin"** function.
