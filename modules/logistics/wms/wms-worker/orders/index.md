...
You can search by scanning or entering an order number, a party name (if any), or any information set up by [Order display format](/logistics/wms/how-to/other-settings/change-order-display-format.md)
