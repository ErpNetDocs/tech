...
Here is what to do if you have information about the SSCC codes and its prior the shipment or not.
...
-- The LU’s data is NOT exchanged prior the shipment arrival and the shipping label DOES NOT contain trade item information
...
You have completed the dispatching of a Sales Order and now you want to pack its products into Logistic Units? You can do that by using the Label menu in WMS Worker. 
