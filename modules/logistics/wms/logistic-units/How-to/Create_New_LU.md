...
To create a new logistic unit, click on the circular **"+"** button located on the **Logistic Units** panel or select one of the **[logistic unit types](../../../common/logistic-unit-types.md)** under the **Create** button.
