...
| KittingControllingLevel | **Description:** Used when working with composite products. Specifies the level of control during the kitting of the composite product’s components. <br/><br/> **Possible values:** 0, 1, 2, 3, 4 <br/><br/> **Action:** Depends on the specified level. For more information, see @levels .|
| DekittingControllingLevel | **Description:** Used when working with composite products. Specifies the level of control during the dekitting of the composite product. <br/><br/> **Possible values:** 0, 1, 2, 3, 4 <br/><br/> **Action:** Depends on the specified level. For more information, see @levels .|
