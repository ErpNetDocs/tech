...
| LogisticUnitScreenVisibility | **Description:** When executing an order line, with this policy you can decide when a logistic unit screen is visible. <br/><br/> **Possible values:** always, default, never <br/><br/> **Action:** Used in the Executing orders' lines in the WMS Worker app. <br/><br/>If there is an applicable policy to the Warehouse and its value is „always“, then the Logistic Unit screen will always show up when executing lines. <br/><br/> If there is an applicable policy to the Warehouse and its value is „default“ or there is no defined policy, then the Logistic Unit screen will show up only if you pick one in the Warehouse Order Line before executing it with the WMS Worker. And also when there is an availability in some Logistic unit for this Product. <br><br>If there is an applicable policy to the Warehouse and its value is „never“, then the Logistic Unit screen will never show up when executing lines. |
