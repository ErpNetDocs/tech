...
This setting is accessible by entering a [Config options reference](href:config-options-reference) - /WMS/WMS-Worker/SingleBarcodeScanEntersQuantityOfOnePce
