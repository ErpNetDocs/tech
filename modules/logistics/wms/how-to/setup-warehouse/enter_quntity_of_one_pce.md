...
This setting is accessible by entering a [Config options reference](xfer:config-options-reference) - /WMS/WMS-Worker/SingleBarcodeScanEntersQuantityOfOnePce
