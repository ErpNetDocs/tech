...
- В поле **Платежна сметка** се избира платежната сметка, участваща в плащания.
- В поле **Посока** се избира посоката за която се използва това осчетоводяване.
...
![Съответствие на платежни сметки със SAF-T счетоводни сметки](pictures/payment-profile.png)


Това съответствие е важно, тъй като то определя кои плащания ще се експортират. Експортират се само плащания с основания, които присъстват в този мапинг. Ако Основанието го няма сред мапингите, то плащания за това основание не се експортира.
В Банковите сметки към тези платежни сметки трябва задължително да има попълнено поле Клон на банка, за да се експортират плащанията за тази банка.
