...
В SAF-T фактурите сумата на фактурата се формира само от сумите на редовете ѝ. Затова допълнителните суми в ERP.net, които увеличават сумата на фактурата се експортират като редове в SAF-T фактурата. Трябва да се укаже и сметка по която се осчетоводяват.
Условието е сумата да има отметки в дефиницията на допълнителната сума "Добавяне към продуктите" и "Добавяне към клиентите" и това да не е ДДС сумата.
...
Необходимо е да се укаже ред за всяка допълнителна сума без ДДС, която увеличава сумата на фактурата. Тези суми трябва да имат отметки "Добавяне към продуктите" и "Добавяне към клиентите".
