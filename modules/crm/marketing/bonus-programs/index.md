...
- Discount – Sets a percentage discount for a specific sales order line. Works as follows: To all lines that meet the conditions, the standard discount percent *is replaced* by the value set in the ‘Bonus Line Discount Percent’ field. In the line field *Bonus program* there is information about the name of the bonus program that is currently applied. Bonus programs do not apply to lines with zero quantity.
