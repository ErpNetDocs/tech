...
This gives the administrator full access to the Client Center.

<!-- Screenshot needed: External Access navigator with a record assigned with role L90 - Owner -->

> [!IMPORTANT]
> A user with role **L90 - Owner** cannot be edited in Client Center.

## Recommendation for external administrators

Use **L90 - Owner** for the ERP.net administrator or the main internal person responsible for the Client Center.

For external users who need to manage other users in Client Center, assign **L80 - Admin** instead of **L90 - Owner**.
