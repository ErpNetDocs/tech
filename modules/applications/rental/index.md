...
Provides a detailed overview of the state of all assets, revealing their **current occupancy** as well as the **current date(s)** on which they are available to lease. These dates can **change** based on the lease contracts a rental asset is part of, but this is always reflected by the report.
