...
Once [Project Types](main-setup/project-types.md) have been defined, the next essential step in setting up **Agile PM** is to define the Case Categories — a required element before any Cases can be created.  
