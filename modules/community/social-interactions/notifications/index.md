...
|30| NT_DOC_TYPE_NOTIFICATIONS | Document | **[R38198](https://docs.erp.net/model/business-rules/R38198.html) Document** - Notify Users For Document Type Notifications |At Document state change, notify user whose e-mail address is listed in [DocumentTypeNotifications](https://docs.erp.net/model/entities/Systems.Documents.DocumentTypeNotifications.html)|
