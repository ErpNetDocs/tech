...
- Event Parameter - registration parameter. The meaning of this parameter is  determined by the type of the event. For more information on event  parameters see [User Business Rules - Events](https://olddocs.erp.net/tech/user-business-rules-events-41146209.html);
...
- Action Type - specifies the type of action to be performed by the rule.  Possible values are: SETVALUE and FAIL. For more information on the  action types see [User Business Rules Actions - Action Types](https://olddocs.erp.net/tech/user-business-rules-actions-action-types-41146283.html);
