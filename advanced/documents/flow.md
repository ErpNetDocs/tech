...
Documents in @@name often have **sub-documents**. Most of the time, they are [automatically generated](generation.md) or created by some [fulfillment function](fulfillment.md). However, manually entering a sub-document is also allowed and sometimes encouraged.
