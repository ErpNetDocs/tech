...
The NOTIFYUSER action is not compatible with all [Business rules - Events](../user-business-rules-events/index.md). For more info look into the following chart.
