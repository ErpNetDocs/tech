...
* External logging or chat services as [Slack](https://slack.com/), [Graylog](https://www.graylog.org/).
...
А **[business rule](../user-business-rules/index.md)** executes a webhook when a service activity is created or updated.
