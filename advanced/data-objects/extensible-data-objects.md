...
> [!NOTE] 
> The [Custom attributes](~/custom-attributes/index.md) system was implemented prior to the Extensible Data Objects system, so it also uses untyped soft reference.
