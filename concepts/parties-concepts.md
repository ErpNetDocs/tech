...
This section explains the codes and numbers assigned to parties and describes a troubleshooting approach for a common issue—the violation of value uniqueness.

Upon creation, Parties are automatically assigned a Party Code, while Customers and Suppliers are automatically assigned Numbers. These values are unique across the system.
...
**What can be done?** troubleshooting:
